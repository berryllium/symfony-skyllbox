...
class GuitarSubject extends AbstractSubject
{
    ...
    protected array $descriptions = [
        'Статья о музыкальных инструментах, как на них играть и как не надо',
        'Статья о гитарах, о самых интересных экзамплярах этого инструмента и об известных фирмах',
    ];
