...
class GuitarSubject extends AbstractSubject
{
    ...
    protected array $paragraphs = [
        ...
        'Суперстраты представляют собой обширное семейство {{ keyword|morph(7) }}, состоящее из множества моделей разных производителей. На вид они несколько напоминают Стратокастеры, но имеют большое количество конструктивных отличий в «звучках», форме головки грифа, струнодержателе, древесине корпуса, грифа и накладки.'
    ];
}